...
public class LoadingView extends ImageView {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.LoadingView_AcTextSize, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.LoadingView_AcTextColor, DEFAULT_BORDER_COLOR);
        mBorderColor_bg = a.getColor(R.styleable.LoadingView_AcTextBgColor, DEFAULT_BORDER_COLOR_BG);
        mAcImage=a.getResourceId(R.styleable.LoadingView_imageSrc,R.drawable.play_bottle_normal);
        mAcImageNoClick=a.getResourceId(R.styleable.LoadingView_imageSrcNoClick,R.drawable.play_bottle_unable);
        a.recycle();
