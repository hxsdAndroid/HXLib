...
public class PlayStateParams {
    ...
    public static final int DANMU_TEXTSIZE_BIG = 20;//大字体

    public static final int DANMU_TEXTSIZE_MEDIUM = 16;//中字体

    public static final int DANMU_TEXTSIZE_SMALL = 13;//小字体
