...
public class LoadingView extends ImageView {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAcImage=a.getResourceId(R.styleable.LoadingView_imageSrc,R.drawable.bottle_normal);
        mAcImageNoClick=a.getResourceId(R.styleable.LoadingView_imageSrcNoClick,R.drawable.bottle_unable);
        a.recycle();
