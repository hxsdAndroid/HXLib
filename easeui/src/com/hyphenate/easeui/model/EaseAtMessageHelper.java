            ...
            if(msg.getChatType() == ChatType.GroupChat){
                ...
                try {
                    ...
                    for(int i = 0; i < jsonArray.length(); i++){
                        ...
                        if(EMClient.getInstance().getCurrentUser().equals(username) && !atMeGroupList.contains(groupId)){
                    ...
                    if(usernameStr != null && usernameStr.toUpperCase().equals(EaseConstant.MESSAGE_ATTR_VALUE_AT_MSG_ALL) && !atMeGroupList.contains(groupId)){
                        atMeGroupList.add(groupId);
                    }
                }
    ...
    public boolean isAtMeMsg(EMMessage message){
        ...
        if(user != null){
            try {
                ...
                if(atUsername != null && atUsername.toUpperCase().equals(EaseConstant.MESSAGE_ATTR_VALUE_AT_MSG_ALL)){
                    return true;
                }
                return  false;
            }
