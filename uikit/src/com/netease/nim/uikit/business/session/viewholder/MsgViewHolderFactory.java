...
import com.netease.nim.uikit.plugin.MsgViewHolderCourse;
import com.netease.nim.uikit.plugin.MsgViewHolderImage;
...
public class MsgViewHolderFactory {
    ...
    static {
        ...
        register(com.netease.nim.uikit.plugin.ImageAttachment.class, MsgViewHolderImage.class);
        register(CourseAttachment.class, MsgViewHolderCourse.class);
        register(SignInAttachment.class, MsgViewHolderUnknown.class);
        register(SignOutAttachment.class, MsgViewHolderUnknown.class);
    }
    ...
    public static List<Class<? extends MsgViewHolderBase>> getAllViewHolders() {
        ...
        list.add(MsgViewHolderImage.class);
        list.add(MsgViewHolderCourse.class);
