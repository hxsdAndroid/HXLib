...
//        nameTextView.setTextColor(NimUIKitImpl.getContext().getResources().getColor(R.color.color_black_ff999999));
    ...
    public static String getNickNameByRemoteExt(ChatRoomMessage message){
        final String KEY = "nickname";
    ...
    public static int getTagByRemoteExt(ChatRoomMessage message){
        final String KEY = "tag";
        Map<String, Object> ext = message.getRemoteExtension();
        if (ext !=null && ext.containsKey(KEY)){
            return Integer.parseInt(String.valueOf(ext.get(KEY)));
        }
        return 0;
    }

    public static String getTagStrByRemoteExt(ChatRoomMessage message){
        final String KEY = "tagName";
        Map<String, Object> ext = message.getRemoteExtension();
        if (ext !=null && ext.containsKey(KEY)){
