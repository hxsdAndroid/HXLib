        ...
        switch (recent.getMsgType()) {
            ...
            case custom:
                if (recent.getAttachment()!=null){
                    if (recent.getAttachment() instanceof ImageAttachment){
                        return "[图片]";
                    }else if(recent.getAttachment() instanceof CourseAttachment){
                        return "[推荐]";
                    }else if(recent.getAttachment() instanceof SignInAttachment){
                        return "[签到]";
                    }else if(recent.getAttachment() instanceof SignOutAttachment){
                        return "[签退]";
                    }else{
                        return "[自定义消息]";
                    }
